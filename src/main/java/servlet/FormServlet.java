...
public class FormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        writer.println("</tr>");
        writer.println("<tr>");
        String result = request.getParameter("catalogRequest") == null ? "No" : "Yes";
        writer.println("<td>Please send me the latest " + "product catalog: " + result + "</td>");
        writer.println("</tr>");
        writer.println("<tr>");
        writer.println("<td>&nbsp;</td>");
        writer.println("<td>All Paramters</td>");
